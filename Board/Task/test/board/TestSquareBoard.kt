...
class TestSquareBoard {
    ...
    fun test15Neighbour() {
        with(createSquareBoard(4)) {
            ...
            Assert.assertEquals(neighbourMessage(cell!!, UP), "(1, 3)", cell.getNeighbour(UP).asString())
            Assert.assertEquals(neighbourMessage(cell, DOWN), "(3, 3)", cell.getNeighbour(DOWN).asString())
            Assert.assertEquals(neighbourMessage(cell, LEFT), "(2, 2)", cell.getNeighbour(LEFT).asString())
            Assert.assertEquals(neighbourMessage(cell, RIGHT), "(2, 4)", cell.getNeighbour(RIGHT).asString())
        }
    }
    ...
    fun test16NullableNeighbour() {
        with(createSquareBoard(4)) {
            ...
            Assert.assertEquals(neighbourMessage(cell!!, UP), "(3, 4)", cell.getNeighbour(UP).asString())
            Assert.assertEquals(neighbourMessage(cell, LEFT), "(4, 3)", cell.getNeighbour(LEFT).asString())
